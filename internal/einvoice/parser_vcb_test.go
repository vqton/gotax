...
func TestVCBParser_GetBankCode(t *testing.T) {
	parser := NewVCBParser()
	if parser.GetBankCode() != "VCB" {
		t.Errorf("expected VCB, got %s", parser.GetBankCode())
	}
}

func TestVCBParser_Validate(t *testing.T) {
	parser := NewVCBParser()
...
func TestVCBParser_Parse(t *testing.T) {
	parser := NewVCBParser()
