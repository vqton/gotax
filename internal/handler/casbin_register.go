...
func RegisterRoutesWithCompanyOpt(r *gin.Engine, h *Handler, ch *CompanyHandler, th *TaxHandler, cashH *CashHandler, bankH *BankHandler, purchaseH *PurchaseHandler, saleH *SaleHandler, whH *WarehouseHandler, faH *FAHandler, pwH *PayrollHandler, recH *RecurringHandler, budH *BudgetHandler, ccdcH *CCDCHandler, ccH *CostCenterHandler, keeperH *WarehouseKeeperHandler, authMW gin.HandlerFunc, adminMW gin.HandlerFunc, extra ...gin.HandlerFunc) {
	RegisterRoutesWithCompany(r, h, ch, th, cashH, bankH, purchaseH, saleH, whH, faH, pwH, recH, budH, ccdcH, ccH, keeperH, authMW, adminMW)
