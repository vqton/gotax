...
var (
	...
	ErrKeeperCompanyRequired      = errors.New("company_id is required")
	ErrKeeperWarehouseRequired    = errors.New("warehouse_id is required")
	ErrKeeperUserRequired         = errors.New("user_id is required")
