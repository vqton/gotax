...
r.GET("/reset-password", func(c *gin.Context) {
	...
	handler.RegisterRoutesWithCompany(r, h, companyH, taxH, cashH, bankH, purchaseH, saleH, whH, faH, pwH, recH, budH, ccdcH, costH, keeperH, costObjectH, costPoolH, authMW, adminMW)
	...
	handler.RegisterRoutesWithCompany(r, h, companyH, taxH, cashH, bankH, purchaseH, saleH, whH, faHMem, pwHMem, recHMem, budHMem, ccdcHMem, costHMem, keeperHMem, costObjectHMem, costPoolHMem, authMW, adminMW)
