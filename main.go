...
func main() {
	...
	whSvc := service.NewWarehouseService(whRepo, whRepo, whRepo, whRepo, whRepo, whRepo, whRepo, whRepo, whRepo)
	...
	whSvc := service.NewWarehouseService(memWhRepo, memCatRepo, memItemRepo, memBalRepo, memTxnRepo, memTrfRepo, memAdjRepo, memTakeRepo, memValRepo)
	whH := handler.NewWarehouseHandler(whSvc)
	handler.RegisterRoutesWithCompany(r, h, companyH, taxH, cashH, bankH, purchaseH, saleH, whH, authMW, adminMW)
