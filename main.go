...
r.GET("/reset-password", func(c *gin.Context) {
	...
	handler.RegisterRoutesWithCompany(r, h, companyH, taxH, cashH, bankH, purchaseH, saleH, whH, faH, pwH, recH, budH, ccdcH, authMW, adminMW)
	...
	handler.RegisterRoutesWithCompany(r, h, companyH, taxH, cashH, bankH, purchaseH, saleH, whH, faHMem, pwHMem, recHMem, budHMem, ccdcHMem, authMW, adminMW)
