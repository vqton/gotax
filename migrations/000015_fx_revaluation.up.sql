...
CREATE INDEX idx_fxr_company ON fx_revaluations (company_id);
CREATE INDEX idx_fxr_status ON fx_revaluations (status);
...
CREATE INDEX idx_fxrl_revaluation ON fx_revaluation_lines (revaluation_id);
CREATE INDEX idx_fxrl_invoice ON fx_revaluation_lines (invoice_id);
